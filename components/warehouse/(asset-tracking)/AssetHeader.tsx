...
export const AssetHeader = ({ onImport, onExport, onAddAsset }: AssetHeaderProps) => {
    return (
                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="max-w-2xl text-body">
                            Monitor and manage all warehouse assets including equipment, machinery,
                            and infrastructure. Track maintenance schedules and asset depreciation.
                        </p>
                    </div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="rounded-2xl border border-primary/20 bg-primary/5 p-4 text-xs">
                        <div className="flex items-center justify-between text-muted-foreground">
                            <span>Last asset added</span>
                            <span className="font-semibold text-foreground">3 days ago</span>
                        </div>
                        <div className="flex items-center justify-between text-muted-foreground">
                            <span>Next maintenance</span>
                            <span className="font-semibold text-foreground">2 Jan 2025</span>
                        </div>
                    </div>
                </div>
            </div>
