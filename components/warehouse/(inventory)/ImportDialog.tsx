        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Upload a CSV or Excel file to update inventory items.
                    </DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                    ...
                    <div className="flex items-center gap-2 rounded-lg border bg-card p-3">
                        ...
                        <div className="flex-1 space-y-0.5">
                            <p className="text-sm font-medium">Inventory_Template.csv</p>
                            <p className="text-xs text-muted-foreground">Sample template</p>
                        </div>
