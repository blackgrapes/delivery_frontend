...
const WeightTabs = ({ activeTab, setActiveTab }: WeightTabsProps) => {
  const getStatusCount = (status: string) => {
    return weightUpdatesData.filter(
      (weight) => status === "all" || weight.status === status
    ).length;
  };
